/*
  ...
  will show more information than just PID and process/path, and may include an ini file
  to configure a few gui-related elements of the program, such as those shown in the 
  Configuration section below. I may one day add information about any network resources
  (eg: local ports) being used by the application, and/or a reverse pfw implementation
...
MainGuiTrans := 225       ;255 is fully visible, 0 is invisible. I think 225 works well.
  ...
  ;This is just to make changing the version/name string easier for me.
                                          ;BACON!                                          This program contains 267 lines, including code, whitespace, and comments, and has 7735 characters.
PFWVerString = ProcFromWin 0.4 beta
...
If Not ErrorLevel
	Gui, 2:Add, Text,, Process was killed successfully. 
